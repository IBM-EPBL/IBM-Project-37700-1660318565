...
def send_email(email):
    html = '''
        ...
        <img src='https://www.pngmart.com/files/1/Blushing-Emoji-PNG-File.png' style='margin-left:20%' width='150px' height = '150px'>
...
def fail_mail(email):
    html = '''
        ...
        <img src='https://i.pinimg.com/564x/6b/91/e5/6b91e55e2ff7ca9133f7a25fba2d5b23.jpg' style='margin-left:20%' width='150px' height = '150px'>
        <p style="text-align:center;">Thank you for visiting our website. Hope you had a great experience</p>
        '''
...
def linear_mail(email,predict):
    html = f'''
        ...
        <img src='https://www.tenforce.com/wp-content/uploads/2020/08/undraw_approve_qwp7-e1603987686875.png' style='margin-left:20%' width='150px' height = '150px'>
